...
/**
 * Structured, versioned measurement record -- the moat schema from the
 * strategy doc (Section 8). Every benchmark run, even in the free CLI,
...
export interface FullReport {
  ...
  task_corpus_size: number;
  proxies: ProxyName[];
  /** TT01/TT02/TT04 records, matching the strategy doc's moat schema (Section 8). */
