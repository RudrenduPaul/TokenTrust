 ...
 * strategy doc's C1 cost gate (near-zero marginal cost per run).
 */
...
// ---------------------------------------------------------------------------
// --live mode: opt-in provider-billed verification (office-hours correction 3,
// eng-review resolution (d)). This is the one real security/cost boundary in
...
/**
 * Locked gate (eng-review resolution (d)):
 *
 ...
 * not merely that the CLI's exit code is 1 (CRITICAL path, eng-review test
 * plan).
 */
